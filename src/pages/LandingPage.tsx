      ...
      <main className="flex-1">
        ...
        <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center">
            ...
            >
              {/* LaTeX-typeset Math Formulas Around Hero Section Text (Desktop Only) */}
              <motion.div 
                initial={{ opacity: 0, rotate: -3 }}
                animate={{ opacity: 0.8, rotate: -3 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className="absolute lg:-left-12 xl:-left-24 top-[6%] hidden lg:block text-slate-500 font-serif text-sm sm:text-base select-none origin-center"
              >
              ...
              <motion.div 
                ...
                animate={{ opacity: 0.8, rotate: 2 }}
                transition={{ duration: 0.6, delay: 0.25 }}
                className="absolute lg:-right-12 xl:-right-24 top-[3%] hidden lg:block text-slate-500 font-serif text-sm sm:text-base select-none origin-center"
              >
              ...
              <motion.div 
                ...
                animate={{ opacity: 0.8, rotate: -1.5 }}
                transition={{ duration: 0.6, delay: 0.3 }}
                className="absolute lg:-left-16 xl:-left-28 top-[53%] hidden lg:block text-slate-500 font-serif text-sm sm:text-base select-none origin-center"
              >
              ...
              <motion.div 
                ...
                animate={{ opacity: 0.8, rotate: 2.5 }}
                transition={{ duration: 0.6, delay: 0.35 }}
                className="absolute lg:-right-16 xl:-right-28 top-[48%] hidden lg:flex items-center text-slate-500 font-serif text-sm sm:text-base select-none origin-center"
              >
              ...
              <motion.div 
                ...
                className="absolute lg:-left-8 xl:-left-20 top-[76%] hidden lg:block text-slate-400 font-serif text-xs select-none origin-center"
              >
              ...
              <motion.div 
                ...
                className="absolute lg:-right-8 xl:-right-20 top-[70%] hidden lg:block text-slate-400 font-serif text-xs select-none origin-center"
              >
              ...
              <motion.div 
                ...
                className="absolute left-[35%] -top-12 hidden lg:block text-slate-400 font-serif text-xs select-none origin-center"
              >
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-indigo-50/50 px-4 py-1.5 text-xs sm:text-sm font-semibold text-primary mb-6 shadow-xs backdrop-blur-xs">
                ...
                Platform Belajar Matematika Diskrit Baru
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
                ...
                <Button size="lg" variant="outline" asChild className="w-full sm:w-auto px-6 py-3.5 sm:py-0 sm:h-12 rounded-xl border-slate-200 hover:bg-slate-100 font-bold cursor-pointer">
                  <a href="#materi" className="w-full h-full flex items-center justify-center">Lihat Materi</a>
                </Button>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative rounded-2xl border border-slate-200 bg-white p-6 md:p-8 backdrop-blur-md">
                ...
                <div className="flex items-center justify-between mb-6 border-b border-slate-100 pb-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-slate-400 font-mono ml-4">workspace-graf-planar.tsx</span>
                  </div>
                  <span className="text-[10px] bg-indigo-50 text-primary px-2.5 py-0.5 rounded-full font-bold">Simulator Interaktif</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4 flex flex-col justify-between">
                    <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 flex-1 flex flex-col justify-between">
                      <div className="flex items-center justify-between mb-4 border-b border-slate-200/50 pb-2">
                        ...
                        <button 
                          ...
                          className="text-[10px] bg-primary/10 text-primary hover:bg-primary hover:text-white px-2.5 py-0.5 rounded font-bold transition-all duration-200 cursor-pointer"
                        >
                          Ubah Graf
                        </button>
                      </div>

                      <div className="flex items-center justify-center h-60 relative bg-slate-50/50 rounded-lg p-2 border border-slate-100/55">
                          ...
                          {nodes.map(node => {
                            ...
                            return (
                              <button
                                ...
                                className={`absolute h-6 w-6 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 transition-all duration-300 flex items-center justify-center text-[10px] font-bold cursor-pointer ${
                                  isSelected 
                    ...
                    <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 flex items-center justify-between transition-colors duration-300">
                      <div>
                        <span className="text-[10px] text-slate-400 uppercase font-black block tracking-wider mb-1">
                  ...
                  <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="font-mono text-xs bg-slate-900 text-slate-300 p-4 rounded-lg border border-slate-800">
                        <div className={`grid ${graphType === 'square' ? 'grid-cols-5' : 'grid-cols-4'} gap-2 text-center font-bold text-primary mb-1 border-b border-slate-800 pb-1`}>
                          <div></div>
                          <div>V1</div>
                          <div>V2</div>
                          <div>V3</div>
                        ...
                        {nodes.map(rowNode => {
                          ...
                          return (
                            <div key={rowNode.id} className={`grid ${graphType === 'square' ? 'grid-cols-5' : 'grid-cols-4'} gap-2 text-center items-center py-1 rounded transition-colors duration-200 ${isRowSelected ? 'bg-primary/20 text-white font-bold' : ''}`}>
        ...
        <section className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 shadow-xl shadow-slate-100/50 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center backdrop-blur-md">
